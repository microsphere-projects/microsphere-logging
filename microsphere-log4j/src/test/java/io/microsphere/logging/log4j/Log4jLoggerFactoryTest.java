...
/**
 * {@link Log4jLoggerFactory} Test
 *
 * @author <a href="mailto:mercyblitz@gmail.com">Mercy</a>
 * @see Log4jLoggerFactory
 * @since 1.0.0
 */
class Log4jLoggerFactoryTest {

    private Log4jLoggerFactory factory;

    @BeforeEach
    void setUp() {
        this.factory = (Log4jLoggerFactory) loadFirstService(LoggerFactory.class);
    }

    @Test
    void testGetDelegateLoggerClassName() {
        assertEquals("org.apache.log4j.Logger", factory.getDelegateLoggerClassName());
    }
